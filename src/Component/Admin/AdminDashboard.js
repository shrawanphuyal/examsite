                        ...
                        <div className="col-md-8">
                            <div className="containertable outline">
                                ...
                                <table className="table table-bordered">
                                    <thead>
                                    <tr>
                                        <th className="firstname">FullName</th>
                                    ...
                                    {
                                        this.state.user_data.map((dynamicData, Key) => {
                                            ...
                                            return keys.map(data => {
                                                return (
                                                    ...
                                                    <tr>
                                                        <td>{dynamicData[data].fullname}</td>
                                                        <td>{dynamicData[data].email}</td>
                                                        <td>{dynamicData[data].status}</td>
                                                        <td>
                                                            ...
                                                            <a
                                                                className={(dynamicData[data].status == "inactive")? "disableLink":"cursor"}
                                ...
                                {/*maxLength="20" placeholder="Search by email"*/}
                                {/*required/>*/}
                                {/*</div>*/}
                                {/*<br/>*/}
                    ...
                    <div className="col-md-4 userinfo">
                        ...
                        <div className="form-group">
                            ...
                            <ul className="list-inline outline">
                                <li>
                                    <input disabled={true} onClick={this.inviteUsers.bind(this)} className="btn btn--form add" type="submit" value="Add"/>
                                </li>
                            ...
                            <br/>
                                ...
                                <a href="#Admin/AdminDashboard/UploadQuest">
                                    <input className="btn btn--form add" type="submit" value="UPLOAD QUESTION"/>
                                </a>
