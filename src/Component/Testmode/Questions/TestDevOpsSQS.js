    ...
    fetchdata(){
        ...
        axios.get(post_api, {
            ...
            .then(response => {
                ...
                var ans_length = [];
                for(var i=0;i<response.data["resSQS"].length;i++){
                    ans_length[i] = response.data["ansSQS"][""+(i+1)].length
                }

                this.setState({
                    fetched_data: response.data["resSQS"],
                    correct_answer:response.data["ansSQS"],
