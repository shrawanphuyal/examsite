...
var post_api = "https://ds8xbume54.execute-api.ap-southeast-1.amazonaws.com/prod/questionare-test-devops";
    ...
    fetchdata(){
        ...
        axios.get(post_api, {
            ...
            .then(response => {
                ...
                var ans_length = [];
                for(var i=0;i<response.data["resIAM"].length;i++){
                    ans_length[i] = response.data["ansIAM"][""+(i+1)].length
                }

                this.setState({
                    fetched_data: response.data["resIAM"],
                    correct_answer:response.data["ansIAM"],
