    ...
    fetchdata(){
        ...
        axios.get(post_api, {
            ...
            .then(response => {
                ...
                var ans_length = [];
                for(var i=0;i<response.data["resS3"].length;i++){
                    ans_length[i] = response.data["ansS3"][""+(i+1)].length
                }

                this.setState({
                    fetched_data: response.data["resS3"],
                    correct_answer:response.data["ansS3"],
